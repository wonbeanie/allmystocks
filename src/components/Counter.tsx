...
import { fetchStockPrice, fetchToken, fetchUsStockPrice } from '../redux/slice/stockApi';
...
const Counter = () => {
  ...
  const apiHandler = async () => {
    ...
    //     console.log(err);
    // }
    // dispatch(fetchStockPrice("005935"));
    // dispatch(fetchUsStockPrice("iShares Expanded Tech Sector ETF"));
  }
